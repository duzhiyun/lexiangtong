<template>
	...
	<view class="page">
		<uni-list class="item-list">
			<uni-list-item title="生活圈" class="item-list-item" :show-arrow="false" :show-badge="false" badge-type="error"
			 :showArrow="true" thumb="/static/theme/default/push/circle.png" @click="goPath('../push/circle')" />
			<!--  #ifdef  APP-PLUS -->
			<uni-list-item title="扫一扫" :show-arrow="false" :show-badge="false" badge-type="error" :showArrow="true" thumb="/static/theme/default/push/scan.png"
			 @click="goScanCode" />
			<!-- #endif -->
			<!--自定义网址-->
			...
			<uni-list-item :title="item.appName" v-if="list.length" v-for="(item,index) in list" :show-arrow="false" :show-badge="false"
			 badge-type="error" :showArrow="true" :thumb="domainUrl +item.logo_url" @click="go" />
		</uni-list>
