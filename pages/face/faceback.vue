...
<!-- 	<view class="content">
	...
	<view style="height: 1500rpx;">
		...
		<view class="lvru">
			...
			<view class="list-ul">
				<view class="list-name">后置摄像头</view>
				<view class="list-inp">
				    <switch :checked="backCamera" @change="(e)=>{backCamera=e.target.value}" />
				</view>	
			</view>
		...
		methods: {
			...
			inter(inx) {
				...
				let config = {
					...
					licenseId: 'so-dtionuoaa-vip-face-android',
				...
				if (plus.os.name == 'iOS') {
					...
					config.licenseId = 'so-dtionuoaa-vip-face-ios';
				}
...
.allwidth{width:100%;height:auto;background-color:#d81e07;text-align:center;}
...
.getreal{width:70%;height:80rpx;border-radius: 40rpx;background-color:#d81e07;margin:0 auto;color:#ffffff;text-align:center}
