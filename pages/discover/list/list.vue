		...
		<view class="community-box" v-else>
			...
			<view class="community-box-con">
                <view class="com-input-title">
	                <view class="input-text"><input type="text" v-model="title" placeholder="请填写标题" autocomplete="off" name="title"></view>
	            </view>
                <view class="com-textarea">
					<textarea name="content" v-model="content" class="text-area1" maxlength="300" placeholder="留下点文字吧"></textarea>
					<text>{{ length }}</text>
                </view>
            </view>
            <view class="btn-bar">
                <view class="btn btn-white" @click="cancel">取消</view>
                <view class="btn btn-red" @click="btnSubmit">确定</view>
            </view>
        </view>
