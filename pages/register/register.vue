	...
	<view>
		<view class="container">
			<view class="loading-login">
				<image src="../../static/logo_img.png"  style="background-color:#ffffff;padding:1rpx;border-radius: 20rpx;border-rborder:11px solid #00AA00;width:192rpx;height:192rpx;"></image>
			</view>
			...
			<view class="cby">
				...
				<view class="loadin-name">
					...
					<view class="kkey" @click="clickCaptcha">
						<image :src="captcha" style="width:100%;hegiht:100%" ></image>
					</view>
				</view>
				...
				<view class="loadin-name">
					<view class="phoneclass">
						<input type="text" name="sms" v-model="sms" maxlength="6" placeholder="请输入短信验证码" class="inp-100"/>
					</view>
					<view class="key">
				...
				<view class="loadin-name">
					<input type="password" name="paypwd" v-model="paypwd" placeholder="请输入6位支付密码"  class="inp-100"/>
				</view>
				
				<view class="loadin-name">
					<input type="text" name="reference " v-model="reference" placeholder="推荐人编号或手机号码" class="inp-100"/>
				</view>
		...
		methods:{
			...
			formSubmit(e){
				var rule = [
					...
					{name:"paypwd", checkType : "notnull", checkRule:"",  errorMsg:"请填写6位支付密码"},
				];
...
.key{width:39%;height:60upx;color:#ffffff; 
...
.inp-100{height:100upx;line-height:100upx;font-size:32upx;color:#000000;text-align:left}
.loading-btn{
	width:100%;
