		...
		<view class="fabu-header">
			...
			<view class="fabu-header-mid">
				...
				<view class="fabu-userinfo" v-else>
					...
					<view  class="fabu-more"><text>未缴预付</text></view>
				</view>
			</view>
...
<!-- 		<view class="fabu-two" >
		...
		<view class="fabu-three">
			<view style="width:94%;margin:30rpx auto" v-for="(item,index) in description" :key="index">
				<view><text>第{{index+1}}步</text></view>
...
.fabu-title{color:#cacaca;line-heighe:30rpx;margin-left:20rpx;font-size:36rpx;white-space:nowrap;overflow:hidden ; text-overflow:ellipsis;}
.fabu-nav{
	width:100%;
	line-height:30rpx;
	display: flex;
...
.fabu-imgteam{font-size:20rpx; width:25%;margin:10rpx 10rpx; text-align:left;padding-left:30rpx}
