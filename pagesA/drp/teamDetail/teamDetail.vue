			...
			<view class="header">
				<view class="header-warp">
					...
					<view class="header-flex">
						...
						<view class="shop-rank">开店时间：{{drpTeamDetailData.reg_time}}</view>
					</view>
