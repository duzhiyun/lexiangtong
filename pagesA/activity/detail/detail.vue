<template>
	<view class="activity-datail" v-if="activityShowsData">
		...
		<view class="section">
			...
			<view class="p">活动时间：<text>{{activityShowsData.start_time}}至{{activityShowsData.end_time}}</text></view>
			<view class="p">金额上限：<text class="text">{{activityShowsData.max_amount}}</text></view>
			<view class="p">金额下限：<text class="text">{{activityShowsData.min_amount}}</text></view>
			<view class="p">享受优惠的会员等级：<text class="text">{{activityShowsData.user_rank}}</text></view>
			<view class="p">优惠方式：<text class="text2">{{activityShowsData.activity_name}}</text></view>
			<view class="p">优惠范围：<text class="text">{{activityShowsData.act_range}}</text></view>
		</view>
		<view class="section">
			<view class="tit">优惠商品</view>
