<template>
    <view class=" con" v-waterfall-lower="loadMore" waterfall-disabled="disabled" waterfall-offset="300">
        <view class="team-order con_main cro_funing">
            ...
            <!--商品列表-->
            <view class="goods-li" v-waterfall-lower="loadMore" waterfall-disabled="disabled" waterfall-offset="300" v-if="crowdMyFocusData && crowdMyFocusData.length > 0">
                <view class="show bg-color-write li"  v-for='(item,index) in crowdMyFocusData' :key="index"
