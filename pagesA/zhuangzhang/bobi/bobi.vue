				...
				<form @submit="formSubmit">
					<view class="cby">
						...
						<view class="loadin-name piont-ico">
							<input type="text" name="money" v-model="money" placeholder="乐享值" class="inp-100"/>
						</view>
						<view class="loadin-name piont-ico">
							<input type="text" name="point" v-model="point" placeholder="乐券" class="inp-100"/>
						</view>
						<view class="loadin-name piont-ico">
							<input type="text" name="bean" v-model="bean" placeholder="乐豆" class="inp-100"/>
						</view>
						<view class="loadin-name grade-ico">
							<input type="text" name="grade" v-model="grade" placeholder="级别请填数字(1/2/3)" class="inp-100"/>
						</view>
