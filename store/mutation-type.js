...
const PURCHASE_NAV ='setPurchaseList'
const PURCHASE_GOODS_LIST='setPurchaseGoodsList'
const PURCHASE_DETAIL ='setPurchaseDetail'
const PURCHASE_ADD_CART ='setPurchaseAddtocart'
const PURCHASE_CART ='setPurchaseCart'
const PURCHASE_DOWN ='setpurchaseDown'
const PURCHASE_UPDATE_CART='setPurchaseUpdatecart'
const PURCHASE_SHOW ='setPurchaseShow'
const PURCHASE_SHOW_DETAIL ='setPurchaseShowDetail'
...
const SCOPE_APP_LOGIN = 'scopeAppLogin'
const SHOP_CONFIG = 'shopConfig'
const SPLASH_AD_POSITION = 'setSplashAdPosition'
const COMMON_CART_NUMBER = 'setCommonCartNumber'

/*客服*/ 
const KEFU_SINGLE_CHAT_LIST = 'kefuSingleChatList'
const KEFU_LOGIN = 'kefuLogin'
...
export{
    ...
    PURCHASE,//供求
    PURCHASE_NAV,//供求导航
    PURCHASE_GOODS_LIST,//供求列表
    PURCHASE_DETAIL,//供求详情
    PURCHASE_ADD_CART,
    PURCHASE_CART,
    PURCHASE_DOWN,
    PURCHASE_UPDATE_CART,
    PURCHASE_SHOW,
	...
	LOCATION,
	SCOPE_APP_LOGIN,
	SHOP_CONFIG,//获取后台设置shopConfig
	SPLASH_AD_POSITION,
	COMMON_CART_NUMBER,//购物车数量
	
	KEFU_LOGIN, // 客服进入聊天页面
	KEFU_SINGLE_CHAT_LIST, // 客服聊天历史记录
