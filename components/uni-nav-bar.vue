		...
		<view class="uni-navbar-header" :style="{color:color}">
			...
			<view class="uni-mp-navbar" v-if="isMpNavbar">
				...
				<view class="menu-warp" :style="{'display':(menu ? 'block' : 'none')}">
					...
					<navigator url="/pages/search/search" open-type="reLaunch" hover-class="none" class="list">
...
<style>
	...
	.uni-mp-navbar .menu-warp .list{ padding: 0 30upx; border-bottom: 2upx solid #F1F0F6; color: #666666; display: flex; flex-direction: row; justify-content: flex-start; align-items: center;}
