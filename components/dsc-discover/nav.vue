<template>
	<view class="com-nav-footer">
		<view class="com-list-footer">
			<view class="lie link" @click="changeNav('pages/discover/index/index')" :class="{'active':type == 'index'}">
				<icon class="iconfont icon-medal tm-icon-size"></icon>
				<text class="txt">社区首页</text>
			</view>
