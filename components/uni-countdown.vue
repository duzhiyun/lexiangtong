<template name="uni-countdown">
	<view class="uni-countdown" :class="{'uni-countdown-not':notStyle}">
		<view class="uni-countdown-numbers" :style="{borderColor:borderColor, color:fontColor, background:bgrColor}" v-if="typeZero && dType">{{d}}</view>
		<view class="uni-countdown-splitor" :style="{color:splitorColor}" v-if="typeZero && dType">:</view>
